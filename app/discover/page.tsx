...
import { Video, Link2, Play, Home, Radio, Users, Clock, Eye, Search, Filter } from "lucide-react";
...
export default function DiscoverPage() {
	...
	const handleWatch = (roomId: string) => {
		// For now, allow access to streams without auth (discovery mode)
	...
	return (
		<div className={`min-h-screen transition-colors duration-300 ${
			...
			<div className="max-w-6xl mx-auto px-6 py-8">
				...
				{/* CTA Banner */}
				{!isAuthenticated && filteredRooms.length > 0 && (
					<motion.div
						initial={{ opacity: 0, y: 20 }}
						animate={{ opacity: 1, y: 0 }}
